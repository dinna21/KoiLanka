// Local image/video files — replace with actual files when available
const khoku = 'https://images.unsplash.com/photo-1579566346927-c68383817156?w=600&q=80';
const hiutsuri = 'https://images.unsplash.com/photo-1598870783886-ec3a9a6f5e22?w=600&q=80';
const blog_pic_8 = '';
const blog_pic_9 = '';
const blog_pic_10 = '';
const facebook_icon = '';
const googleplus_icon = '';
const twitter_icon = '';
const logo = '';
const arrow = '';
const logo_light = '';
...
const KoiLogo = '';
const Koi1 = '';
const koiRound = 'https://images.unsplash.com/photo-1579566346927-c68383817156?w=200&q=80';
export const assets = {
    facebook_icon,
    googleplus_icon,
    twitter_icon,
